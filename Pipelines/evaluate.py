...
crf_phi_test_file  = os.path.join("NERResources","Models","phi_tester.pkl")
...
sections_oncology_file = os.path.join("NERResources","Models","sections_oncology.pkl")
sections_procedure_file = os.path.join("NERResources","Models","sections_procedure.pkl")
sections_ed_file = os.path.join("NERResources","Models","sections_ed.pkl")
sections_discharge_summary_file = os.path.join("NERResources","Models","sections_discharge_summary.pkl")



crf_ner_model = load_pickle(crf_ner_file)
crf_phi_model = load_pickle(crf_phi_file)
crf_phi_test_model = load_pickle(crf_phi_test_file)
...
sections_oncology_model = load_pickle(sections_oncology_file)
sections_procedure_model = load_pickle(sections_procedure_file)
sections_ed_model = load_pickle(sections_ed_file)
sections_discharge_summary_model = load_pickle(sections_discharge_summary_file)


models = {"breast_path_ner":breast_path_ner_model, "breast_path_laterality":breast_path_laterality_model, 
         "sections_oncology":sections_oncology_model, "sections_procedure":sections_procedure_model, 
          "phi": crf_phi_model,"phi_tester": crf_phi_test_model,"pinz_ner":pinz_ner_model,"sections_discharge_summary":sections_discharge_summary_model,
          "sections_ed":sections_ed_model, "crf_ner":crf_ner_model}
